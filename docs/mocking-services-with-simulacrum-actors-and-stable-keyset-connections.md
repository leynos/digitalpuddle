...
<!-- markdownlint-disable-file MD013 --> <!-- Long imported prose lines are
...
If you need snapshot semantics, include a snapshot identifier in scope and
...
your simulator models service behaviour.
...
assertions than real outbound HTTP delivery. Use full webhook delivery when
your product’s webhook receiver forms part of the behaviour under test.
...
hosts a small pocket universe with laws. Your application can poke it, anger
it, page through it, mutate it, authenticate to it, retry against it, and still
receive answers that make sense.

<!-- markdownlint-disable MD013 -- Imported long-form guide keeps source
paragraphs intact. -->
